...
<table>
  <tr>
    ...
    <td width="70%"><img src="https://github.com/kartikshankar-nyc/kartikshankar-ohmyposh-theme/raw/main/zoomed_segments/apple_icon.png" alt="Apple Icon" width="100%"></td>
  </tr>
  <tr>
    <td width="30%"><strong>Username display with a person icon</strong></td>
    <td width="70%"><img src="https://github.com/kartikshankar-nyc/kartikshankar-ohmyposh-theme/raw/main/zoomed_segments/username.png" alt="Username" width="100%"></td>
  </tr>
  <tr>
    <td width="30%"><strong>Computer name with a computer icon</strong></td>
    <td width="70%"><img src="https://github.com/kartikshankar-nyc/kartikshankar-ohmyposh-theme/raw/main/zoomed_segments/computer_name.png" alt="Computer Name" width="100%"></td>
  </tr>
  <tr>
    <td width="30%"><strong>Root user indicator</strong></td>
    <td width="70%"><img src="https://github.com/kartikshankar-nyc/kartikshankar-ohmyposh-theme/raw/main/zoomed_segments/root_indicator.png" alt="Root Indicator" width="100%"></td>
  </tr>
  <tr>
    <td width="30%"><strong>Current directory path with folder icon</strong></td>
    <td width="70%"><img src="https://github.com/kartikshankar-nyc/kartikshankar-ohmyposh-theme/raw/main/zoomed_segments/directory_path.png" alt="Directory Path" width="100%"></td>
  </tr>
  <tr>
    <td width="30%"><strong>Git status information with Octocat icon</strong></td>
    <td width="70%"><img src="https://github.com/kartikshankar-nyc/kartikshankar-ohmyposh-theme/raw/main/zoomed_segments/git_status.png" alt="Git Status" width="100%"></td>
  </tr>
  <tr>
    <td width="30%"><strong>Time display on the right side</strong></td>
    <td width="70%"><img src="https://github.com/kartikshankar-nyc/kartikshankar-ohmyposh-theme/raw/main/zoomed_segments/time_display.png" alt="Time Display" width="100%"></td>
  </tr>
  <tr>
    <td width="30%"><strong>Clean prompt character for input</strong></td>
    <td width="70%"><img src="https://github.com/kartikshankar-nyc/kartikshankar-ohmyposh-theme/raw/main/zoomed_segments/prompt_character.png" alt="Prompt Character" width="100%"></td>
  </tr>
</table>
